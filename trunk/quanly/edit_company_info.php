...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  MySQLUPDATE('configurations', array('name' => 'company_side_fone1'), array('value' => $_POST['company_side_fone1']));
  MySQLUPDATE('configurations', array('name' => 'company_side_fone2'), array('value' => $_POST['company_side_fone2']));
  MySQLUPDATE('configurations', array('name' => 'company_address'), array('value' => $_POST['company_address']));
