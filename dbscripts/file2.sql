...
insert  into `products`(`id`,`product_category`,`product_name`,`product_description`,`product_price`,`product_image`,`deleted`,`created_date`,`updated_date`) values (1,1,'Mun 1','Mun luoi thep chong muoi',30000,NULL,'0',NULL,'2010-10-17 10:14:35'),(2,1,'Mun 2','Mun vai chong muoi',10000,NULL,'0',NULL,'2010-10-17 10:14:31'),(3,2,'Mem long cuu','Mem long cuu xuat xu Chau Au',500000,NULL,'0',NULL,NULL);
