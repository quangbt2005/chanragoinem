...
/************************************************/
    ...
    function buildPanels() {
      ...
      j_panels.css({
        ...
        /*'overflow':'hidden',*/
        /*'background':'white',*/
        'background':'url(/images/body_bkg/big_box.png) no-repeat scroll 0 0 transparent',
        'display':'none',
        'padding':'15px'
      });
    ...
    function buildFilmstrip() {
      ...
      $('<img />').addClass('nav-next').attr('src',img_path+opts.nav_theme+'/next.png').appendTo(j_gallery).css({
        ...
        'top':'520px',
        /*'right':(gallery_width/2)-(wrapper_width/2)-10-50+'px'*/
        'right':'10px',
        'width':'32px',
        'height':'32px'
      }).click(showNextItem);
      $('<img />').addClass('nav-prev').attr('src',img_path+opts.nav_theme+'/prev.png').appendTo(j_gallery).css({
        ...
        /*'top':(opts.filmstrip_position=='top'?0:opts.panel_height)+frame_margin_top+((opts.frame_height-22)/2)+'px',*/
        'top':'520px',
        /*'left':(gallery_width/2)-(wrapper_width/2)-10-50+'px'*/
        'left':'10px',
        'width':'32px',
        'height':'32px'
      }).click(showPrevItem);
